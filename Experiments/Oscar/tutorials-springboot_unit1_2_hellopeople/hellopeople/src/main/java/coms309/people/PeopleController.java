...
public class PeopleController {
    ...
    @PutMapping("/people/{fname1}-atk-{fname2}")
    public @ResponseBody Person updatePerson(@PathVariable String fname1, @PathVariable String fname2,
                                             @RequestBody Person p) {
        peopleList.replace(fname2, p);
        return peopleList.get(fname2);
    }
